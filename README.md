...
4. Go to firebase and start a project
   ```sh
   https://firebase.google.com/
   ```
5. Starts the Authentication & Firestore Database sections

6. Get & Enter your API KEYS in `.env.test` file
   ```js
   API_KEY = 'ENTER YOUR API';
   ```
7. Start project testing part
   ```sh
   npm run test
   ```
